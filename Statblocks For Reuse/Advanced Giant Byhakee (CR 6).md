...
**XP 1,200**  
CE Medium [aberration](https://www.d20pfsrd.com/bestiary/rules-for-monsters/creature-types#TOC-Aberration)  
...
### DEFENSE
**AC** 23, [touch](https://www.d20pfsrd.com/gamemastering/combat#TOC-Touch-Attacks) 14, [flat-footed](https://www.d20pfsrd.com/gamemastering/conditions#TOC-Flat-Footed) 19 (+4 [Dex](https://www.d20pfsrd.com/basics-ability-scores/ability-scores#TOC-Dexterity-Dex-), +9 [natural](https://www.d20pfsrd.com/basics-ability-scores/glossary#TOC-Natural-Armor-Bonus))  
**hp** 80 (5d8+40)  
...
**Feats** [Flyby Attack](https://www.d20pfsrd.com/feats/monster-feats/flyby-attack), [Improved Initiative](https://www.d20pfsrd.com/feats/combat-feats/improved-initiative-combat/), [Weapon Focus](https://www.d20pfsrd.com/feats/combat-feats/weapon-focus/) (claw)  
**Skills** [Fly](https://www.d20pfsrd.com/skills/fly) +15, [Perception](https://www.d20pfsrd.com/skills/perception) +11, [Stealth](https://www.d20pfsrd.com/skills/stealth) +11, [Survival](https://www.d20pfsrd.com/skills/survival) +11  
**Languages** Aklo  
**SQ** low metabolism, [no breath](https://www.d20pfsrd.com/bestiary/rules-for-monsters/universal-monster-rules#TOC-No-Breath-Ex-), starflight, Yellow Sign affinity

### SPECIAL ABILITIES

#### Bloodlust (Ex)
When a byakhee successfully bites a living creature, it is swiftly driven to a frenzied bloodlust. For 1 minute after it bites a target, it gains a +2 [morale bonus](https://www.d20pfsrd.com/basics-ability-scores/glossary#TOC-Morale-Bonus) on attack and damage rolls against that target. A byakhee has no limit as to how many simultaneous bloodlust targets it can have at any one time, but it generally focuses on the same target once its bloodlust is engaged. It also gains these bonuses on attack and damage rolls against creatures taking [bleed](https://www.d20pfsrd.com/gamemastering/conditions#TOC-Bleed) damage from any source.
#### Low Metabolism (Ex)
While a byakhee craves blood if it hasn’t fed within the last 24 hours, it doesn’t suffer any negative effects from starvation, and it can, in theory, survive forever without drinking or feeding. It is immune to effects that induce magical starvation or thirst, yet it still seeks to drink blood whenever it can to sate its desire. Its strange metabolism and body also render it immune to critical hits, [sneak attacks](https://www.d20pfsrd.com/classes/core-classes/rogue#TOC-Sneak-Attack), and other forms of precision damage.
#### Starflight (Su)
...
A byakhee is immune to the effects of the Yellow Sign, and by concentrating, it can locate the nearest active Yellow Sign as per [discern location](https://www.d20pfsrd.com/magic/all-spells/d/discern-location) (CL 20th). When an active Yellow Sign is visible, a byakhee gains [fast healing](https://www.d20pfsrd.com/bestiary/rules-for-monsters/universal-monster-rules#TOC-Fast-Healing-Ex-) 2 and a +4 [enhancement bonus](https://www.d20pfsrd.com/basics-ability-scores/glossary#TOC-Enhancement-Bonus) to its [Dexterity](https://www.d20pfsrd.com/basics-ability-scores/ability-scores#TOC-Dexterity-Dex-). An active Yellow Sign is either one that was created by Hastur or by the Yellow Sign spell. Inactive Yellow Signs, such as the [unholy](https://www.d20pfsrd.com/magic-items/magic-weapons/magic-weapon-special-abilities/unholy) symbols carried by cultists of Hastur, do not bolster a byakhee, but these creatures generally treat those who openly wear such symbols as allies. A character who displays a Yellow Sign in this manner gains a +5 [circumstance bonus](https://www.d20pfsrd.com/basics-ability-scores/glossary#TOC-Circumstance-Bonus) on all [Bluff](https://www.d20pfsrd.com/skills/bluff), [Diplomacy](https://www.d20pfsrd.com/skills/diplomacy), and [Intimidate](https://www.d20pfsrd.com/skills/intimidate) checks against a byakhee.
### ECOLOGY
**Environment** any air  
...
Byakhees’ ability to fly between worlds through the depths of space is shared by several other types of creatures, many of which are tied in similar ways to the Elder Mythos. They are often called upon by spellcasters who use rare or forbidden magic to take advantage of such transport, yet unlike shantaks, who can impart some of their defenses against the depths of space to those they carry through the gulfs between worlds, byakhees can offer no such protection. The creatures delight in carrying ignorant spellcasters into the cold, airless void when foolishly commanded, as they feel no need to warn their would-be passengers of the dangers of interstellar travel.
...
Priests of Hastur can conjure byakhees with the proper magic, as can spellcasters who use rare and eldritch spells (such as contact entity I, which uses a silver whistle as the material component). Once called to a new world to serve the cult of the King in Yellow, byakhees are quick to establish a colony. Young are hatched from noxious, leathery eggs and grow to maturity over the course of only a few weeks. Yet, once a local byakhee population reaches a few dozen, they lose the drive to procreate entirely. Only in rare cases, such as within the streets of the alien city of Carcosa or on worlds that have fallen fully under Hastur’s control, are byakhees encountered in significantly larger numbers.

Despite their bestial appearance, byakhees are as smart as the typical human and much wiser and charismatic than most. As such, it isn’t uncommon for leaders among their kind to grow in power by gaining class levels. Byakhees can excel in most classes, although they tend to avoid taking levels in classes that grant companions, mounts, or familiars— they find the presence of creatures from the natural world unpleasant at best. Most byakhees that take class levels do so as [barbarians](https://www.d20pfsrd.com/classes/core-classes/barbarian), [clerics](https://www.d20pfsrd.com/classes/core-classes/cleric) of Hastur, [psychics](https://www.d20pfsrd.com/alternative-rule-systems/occult-adventures/occult-classes/psychic), or [sorcerers](https://www.d20pfsrd.com/classes/core-classes/sorcerer) with the aberrant or starsoul bloodlines.